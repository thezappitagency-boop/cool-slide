(function ($) {
  ...
  $(window).on("elementor/frontend/init", function () {
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-testimonial-zigzag.default",
      tp_testimonial_slider
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-career-carousel.default",
      tp_career_slider_active
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-corporate-text-slider.default",
      crp_text_slider_active
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-crypto-testimonial-list.default",
      cr_testimonial_active
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-it-project-slider.default",
      it_project_active
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-it-testimonial.default",
      it_testimonial_active
    );
    elementorFrontend.hooks.addAction(
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-testimonial-list.default",
      tp_testi_slider
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-shop-hero.default",
      shop_banner_slider
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-hero-slider-text.default",
      design_hero_slider_active
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/step-item.default",
      studio_step_slider_active
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-architecture-brand-slider.default",
      tp_ar_brand_slider
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-hero-image-slider.default",
      tp_home_slider_active
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ai-instagram.default",
      ai_instagram_active
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-startup-video.default",
      tp_brands_slider
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-portfolio-slider.default",
      tp_port_brands_slider
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-shop-text-slider.default",
      tp_shop_text_slider
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-about-me-hero.default",
      tp_about_brands_slider
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-about-text-slider.default",
      tp_about_text_slider
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-team-list.default",
      tp_team_slider_active
    );
  });
})(jQuery);
