...
// from meta
$facebook_url = get_the_author_meta('agntix_facebook');
$custom_avater = get_the_author_meta('agntix_author_avater');
$twitter_url = get_the_author_meta('agntix_twitter');
$dribbble_url = get_the_author_meta('agntix_dribbble');
$instagram_url = get_the_author_meta('agntix_instagram');

$author_bio_avatar_size = 88;
if ($author_data != ''):
    ?>
        ...
        <div class="sidebar-widget-author d-flex align-items-start">
            ...
            <div class="postbox-details-content">
                <div class="sidebar-widget-author-content">
                    <h4 class="sidebar-widget-author-name">
                        <a href="<?php print esc_url(get_author_posts_url(get_the_author_meta('ID'))) ?>">
                            <?php print esc_html($author_name); ?>
                        </a>
                    </h4>
                    <p>
                        <?php echo agntix_kses($author_data); ?>
                    </p>
                </div>
