...
$agntix_search_btn = get_theme_mod( 'agntix_blog_btn', 'Read More' );
$agntix_search_btn_switch = get_theme_mod( 'agntix_blog_btn_switch', true );

?>


<?php if ( !empty( $agntix_search_btn_switch ) ): ?>
<div class="tp-blog-grid-btn">
    <a href="<?php the_permalink();?>" class="tp-link-btn-3">
        <?php print esc_html( $agntix_search_btn );?>
        <span>
