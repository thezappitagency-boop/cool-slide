...
<div class="postbox-tag postbox-details-tag">
    <?php if (!empty($agntix_blog_cat) && !empty($terms) && !is_wp_error($terms)): ?>
        ...
        ?>
        <span>
            <a data-bg-color="<?php echo esc_attr($color); ?>" href="<?php echo esc_url(get_term_link($term->term_id)); ?>"
                rel="tag">
                <i>
    ...
    <span><?php echo tp_post_read_count(); ?></span>
</div>