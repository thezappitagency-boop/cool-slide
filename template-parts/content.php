...
$heading_excerpt_class = !empty(get_the_excerpt()) ? 'mb-25' : '';

$excerpt = wp_trim_words(get_the_excerpt(), 30, '[…]');

if (is_single()): ?>
    <!-- details start -->
    <article id="post-<?php the_ID(); ?>" <?php post_class('tp-postbox'); ?>>
        <div class="postbox-details-item item-border mb-20">
            <div class="postbox-details-info-wrap">
                <?php get_template_part('template-parts/blog/blog-single-cat-meta'); ?>
            </div>
