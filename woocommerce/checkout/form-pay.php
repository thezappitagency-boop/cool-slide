	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'agntix' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'agntix' ); ?></th>
			</tr>
		</thead>
		<tbody>
